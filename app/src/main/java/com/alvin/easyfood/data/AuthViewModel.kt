package com.alvin.easyfood.data
...
import com.main.easyfood.navigation.ROUTE_HOME
    ...
    fun signup(email:String,pass:String,confpass:String){
        ...
        if (email.isBlank() || pass.isBlank() ||confpass.isBlank()){
            ...
            mAuth.createUserWithEmailAndPassword(email,pass).addOnCompleteListener {
                if (it.isSuccessful){
                    val userdata= com.alvin.easyfood.models.User(email,pass,mAuth.currentUser!!.uid)
